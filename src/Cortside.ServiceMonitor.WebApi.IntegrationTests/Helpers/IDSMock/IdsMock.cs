using System.IO;
using System.Linq;
using Cortside.ServiceMonitor.WebApi.IntegrationTests.Data.Ids;
using Newtonsoft.Json;
using WireMock.RequestBuilders;
using WireMock.ResponseBuilders;
using WireMock.Server;

namespace Cortside.ServiceMonitor.WebApi.IntegrationTests.Helpers.IDSMock {
    public class IdsMock {
        ...
        public void Configure() {
            ...
            mockServer
                .Given(
                Request.Create().WithPath($"/runtime/policy/ServiceMonitor*")
                    .UsingPost()
            )
            .RespondWith(
                Response.Create()
                    .WithStatusCode(200)
                    .WithBody(r => $"{{\"roles\":[\"Internal\"],\"permissions\":[\"CreateServiceMonitor\",\"GetServiceMonitor\",\"GetServiceMonitor\",\"SignServiceMonitor\",\"VoidServiceMonitor\",\"ActivateServiceMonitor\",\"GetServiceMonitorso\",\"GetServiceMonitorsos\"]}}")
            );
