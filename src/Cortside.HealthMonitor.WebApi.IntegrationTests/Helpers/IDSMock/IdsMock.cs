    ...
    public class IdsMock {
        ...
        public void Configure() {
            ...
            .RespondWith(
                Response.Create()
                    .WithStatusCode(200)
                    .WithBody(r => $"{{\"roles\":[\"Internal\"],\"permissions\":[\"CreateHealthMonitor\",\"GetHealthMonitor\",\"GetHealthMonitor\",\"SignHealthMonitor\",\"VoidHealthMonitor\",\"ActivateHealthMonitor\",\"GetHealthMonitorso\",\"GetHealthMonitorsos\"]}}")
            );
